...
The hardcoded random.org API key (`cff4f1e6-9e8d-4446-a4b2-ae57ac5550da`) is a free public development key licensed for testing only, please change API keys for commercial deployments.

Commercial deployments should use a separately licensed key obtained from https://api.random.org/pricing
